<?php
    /**
    * Questo script ottiene lo spazio libero e occupato sul disco di sistema
    * > Compatibile con la maggior parte dei sistemi operativi
    * 
    * Javascript ("/static/js/main/options.js") esegue una GET request
    * a questa pagina per richiedere le informazioni e le usa per visualizzarle
    * nel grafico a ciambella nella pagina delle impostazioni
    *
    * @since 01_01
